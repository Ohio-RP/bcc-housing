Hotels = {
    -- Valentine
    {
        ...
        cost = 90,                                   --cost to buy the hotel room
        invSpace = 50,                              --Amount of inventory room the hotel will have
        blip = {
    ...
    -----------------------------------------------------
        ...
        -- Van Horn
        {
            hotelId = 8,                                --Make sure this is a unique number for each hotel (once set do not change it will break!)
            location = vector3(2904.343, 1340.505, 48.370), --location of where you will buy and enter the hotel room
            name = 'Annesburg Hotel',                      --Name of the hotel
            cost = 90,                                  --cost to buy the hotel room
            invSpace = 50,                             --Amount of inventory room the hotel will have
            blip = {
                name = 'Annesburg Hotel',                  --Name of the blip on the map
                sprite = -211556852,                    --Default: -211556852 / blip_hotel_bed
                show = true,                            --Show the blip on the map
                color = 'BRIGHT_BLUE',                  --Color of the blip (Blip Colors Shown in 'main.lua' config)
            }
